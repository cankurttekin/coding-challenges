...
.data
mesaj0:	.asciiz "**** greatest-common-divisor  ****\n"
mesaj1: .asciiz "x: "
mesaj2: .asciiz "y: "
mesaj3:	.asciiz "gcd(x,y)			      : "
mesaj4:	.asciiz "Calculate again or exit y/n: "
mesaj5:	.asciiz "Exiting...\n"
newline: .asciiz "\n"
...
user:                   # kullanıcıya tamam mı devam mı soruyoruz.
      ...
      li $v0, 4
      syscall
      j user            # eğer 'y' veya 'n' dışında bir tuşlama yapıldıysa tekrar sormak için user a dönüyoruz.
